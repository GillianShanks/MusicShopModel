...
public class Piano extends Instrument{
    ...
    public Piano(double wholesalePrice, double sellingPrice, String brand, String material, String colour, InstrumentType instrumentType, PianoType pianoType, KeyType keyType) {
